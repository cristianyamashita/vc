...
ICONS: dict[str, list[Shape]] = {
    ...
    "os-upgrade": [
        r(6, 8, 20, 15, rad=2),
        r(8, 10, 16, 9, rad=1, fill=DARK),
        p([(16, 11), (20, 16), (17.5, 16), (17.5, 18.5), (14.5, 18.5), (14.5, 16), (12, 16)]),
        r(13, 23, 6, 2, rad=0.5),
    ],
    "os-apps-upgrade": [
        r(6, 8, 20, 15, rad=2),
    ...
    "game-voxelcraft": [
        p([(16, 6), (26, 11), (16, 16), (6, 11)]),
        p([(6, 11), (16, 16), (16, 25), (6, 20)]),
        p([(16, 16), (26, 11), (26, 20), (16, 25)], fill=DARK),
        l(9, 23, 20, 12, sw=2),
        p([(18, 8), (24, 11), (21, 15), (15, 12)]),
    ],
    "game-service-tycoon": [
        r(8, 12, 16, 14),
        p([(8, 12), (16, 6), (24, 12)]),
    ...
    "game-story-studio": [
        r(5, 13, 22, 13, rad=1.5),
        p([(4, 11.5), (25, 6), (27, 10.2), (6, 15.7)]),
        p([(10.2, 10.6), (12.9, 9.9), (14.2, 12.7), (11.5, 13.4)], fill=TEAL),
        p([(17.4, 8.6), (20.1, 7.9), (21.4, 10.7), (18.7, 11.4)], fill=TEAL),
        c(16, 18.4, 1.7, fill=DARK),
