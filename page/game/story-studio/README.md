...
| `bel` | girl | 1.14 m | 0.52 | bob 0.3 | `casual` `dress` `swim` |
...
| `leo` | man | 1.81 m | 0.55 | short | `casual` `work` `swim` `shirt` `pyjamas` |
| `lia` | girl | 1.27 m | 0.46 | braid 0.6 | `casual` `dress` `swim` |
| `mira` | woman | 1.59 m | 0.7 | bob 0.3 | `casual` `dress` `swim` `pyjamas` |
...
| `ravi` | boy | 1.18 m | 0.46 | crop | `casual` `swim` `pyjamas` |
...
| `zeca` | boy | 1.34 m | 0.5 | short | `casual` `swim` `pyjamas` |
