...
function collector() {
  const out = [];
  const p = (w, h, d, color, x, y, z) => {
    out.push({ w, h, d, color, x, y, z, flat: true, grain: 0 });
  };
  return { out, p };
}
...
export function legacyMobParts(kind, wear, look) {
  ...
  if (kind === 'cow') {
    ...
    p(0.08, 0.12, 0.06, 0x3a2414, 0.58, 1.08, -0.1);
    p(0.12, 0.42, 0.12, 0x4a3018, 0.28, 0.22, 0.16);
    p(0.12, 0.42, 0.12, 0x4a3018, 0.28, 0.22, -0.16);
    p(0.12, 0.42, 0.12, 0x4a3018, -0.28, 0.22, 0.16);
    p(0.12, 0.42, 0.12, 0x4a3018, -0.28, 0.22, -0.16);
    ...
    p(0.1, 0.4, 0.1, 0x1a1814, 0.26, 0.22, 0.14);
    p(0.1, 0.4, 0.1, 0xf2eee6, 0.26, 0.22, -0.14);
    p(0.1, 0.4, 0.1, 0xf2eee6, -0.26, 0.22, 0.14);
    p(0.1, 0.4, 0.1, 0x1a1814, -0.26, 0.22, -0.14);
    ...
    p(0.05, 0.16, 0.05, 0xf0a020, 0.06, 0.08, 0.06);
    p(0.05, 0.16, 0.05, 0xf0a020, 0.06, 0.08, -0.06);
  } else if (kind === 'sheep') {
    p(0.7, 0.5, 0.5, 0xf0ece2, 0, 0.58, 0);
    p(0.26, 0.24, 0.24, 0xc4b090, 0.4, 0.62, 0);
    p(0.1, 0.32, 0.1, 0xc4b090, 0.22, 0.18, 0.14);
    p(0.1, 0.32, 0.1, 0xc4b090, 0.22, 0.18, -0.14);
    p(0.1, 0.32, 0.1, 0xc4b090, -0.22, 0.18, 0.14);
    p(0.1, 0.32, 0.1, 0xc4b090, -0.22, 0.18, -0.14);
  } else if (kind === 'lion') {
    ...
    p(0.12, 0.36, 0.1, fur, 0.24, 0.2, 0.14);
    p(0.12, 0.36, 0.1, fur, 0.24, 0.2, -0.14);
    p(0.12, 0.36, 0.1, fur, -0.24, 0.2, 0.14);
    p(0.12, 0.36, 0.1, fur, -0.24, 0.2, -0.14);
  } else if (kind === 'tiger') {
    ...
    p(0.1, 0.12, 0.06, 0xf4f0e4, 0.62, 0.78, -0.1);
    p(0.1, 0.34, 0.1, stripe, 0.26, 0.18, 0.12);
    p(0.1, 0.34, 0.1, fur, 0.26, 0.18, -0.12);
    p(0.1, 0.34, 0.1, fur, -0.26, 0.18, 0.12);
    p(0.1, 0.34, 0.1, stripe, -0.26, 0.18, -0.12);
  } else if (kind === 'bull') {
    ...
    p(0.12, 0.5, 0.12, pants, 0, 0.26, 0.1);
    p(0.12, 0.5, 0.12, pants, 0, 0.26, -0.1);
    p(0.2, 0.48, 0.36, pants, 0, 0.56, 0);
    p(0.22, 0.5, 0.38, cloth, 0, 1.05, 0);
    p(0.1, 0.42, 0.1, cloth, 0, 1.0, 0.24);
    p(0.1, 0.42, 0.1, cloth, 0, 1.0, -0.24);
